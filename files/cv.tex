...
\begin{itemize}
    ...
    \item Developed TrajEval, a diagnostic framework that measures code agent capabilities (search, read, write) via oracle trajectory grounding, moving beyond binary pass@k (under review, EMNLP 2026).
\end{itemize}
