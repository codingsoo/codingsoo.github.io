...
\begin{itemize}
  ...
  maximize code/fault coverage (ASE 2023, ISSTA 2022).
  \item Designed semantic graph-based state representation for REST API testing, enabling agents
  to reason about resource dependencies and action constraints across 15+ real-world services,
  achieving 34\% higher branch coverage than baselines (ICSE 2025).
